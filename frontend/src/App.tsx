...
const MovieRecommendations = lazy(() => import('./components/MovieRecommendations').then((module) => ({ default: module.MovieRecommendations })));
        ...
        <Suspense fallback={<RouteFallback />}>
          <AnimatePresence mode="wait" initial={false}>
            ...
            >
              ...
              ) : route.screen === 'learning' && route.mode === 'movie_recommendations' ? (
                <MovieRecommendations onBack={() => navigateTo('/')} />
