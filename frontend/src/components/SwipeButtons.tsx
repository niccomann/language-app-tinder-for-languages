  ...
  return (
    <div className="flex gap-12 justify-center items-center">
      ...
      <button
        ...
        disabled={disabled}
        className={`relative w-24 h-24 ${UI_RADIUS.touchIcon} bg-success text-on-primary flex items-center justify-center transition-colors duration-150 hover:bg-success/90 disabled:opacity-40 disabled:cursor-not-allowed`}
        aria-label="Know"
      >
