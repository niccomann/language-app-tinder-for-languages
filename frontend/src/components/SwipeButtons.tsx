  ...
  return (
    <div className="flex gap-12 justify-center items-center">
      <button
        ...
        disabled={disabled}
        className="group relative w-24 h-24 rounded-full bg-gradient-to-br from-red-500 via-red-600 to-pink-600 text-white flex items-center justify-center hover:scale-110 active:scale-95 transition-all duration-300 shadow-2xl shadow-red-400/60 hover:shadow-red-500/80 border-4 border-white hover:border-red-100
      ...
      <button
        ...
        disabled={disabled}
        className="group relative w-24 h-24 rounded-full bg-gradient-to-br from-green-500 via-green-600 to-emerald-600 text-white flex items-center justify-center hover:scale-110 active:scale-95 transition-all duration-300 shadow-2xl shadow-green-400/60 hover:shadow-green-500/80 border-4 border-white hover:border-green-100
                   disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:scale-100"
        aria-label="Know"
      >
        <Check size={40} strokeWidth={3.5} className="group-hover:scale-110 transition-transform duration-300" />
