...
const isDeprecatedAiVideoEnabled = () => false;

class SoraService {
  private checkAiVideosEnabled(): void {
    if (!isDeprecatedAiVideoEnabled()) {
      throw new Error('AI video generation is deprecated and not available in the main app flow');
    }
  }
