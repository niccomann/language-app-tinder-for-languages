...
export const featureFlowItems: FeatureFlowItem[] = [
  ...
  {
    id: 'word-match',
    title: copy.featureFlow.wordMatch.title,
    missionLabel: copy.featureFlow.wordMatch.missionLabel,
    description: copy.featureFlow.wordMatch.description,
    route: '/word-match',
    guideId: 'wordMatch',
    phase: 'collection',
    tone: 'teal',
    order: 40,
    ctaLabel: copy.featureFlow.wordMatch.ctaLabel,
  },
  {
    id: 'build-sentence',
  ...
  {
    id: 'listen-sentences',
    title: copy.featureFlow.listenSentences.title,
    missionLabel: copy.featureFlow.listenSentences.missionLabel,
    description: copy.featureFlow.listenSentences.description,
    route: '/sentence-practice',
    guideId: 'listenSentences',
    phase: 'collection',
    tone: 'amber',
    order: 42,
    ctaLabel: copy.featureFlow.listenSentences.ctaLabel,
  },
  {
    id: 'your-vocabulary',
