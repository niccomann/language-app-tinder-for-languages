#!/usr/bin/env bash
# =============================================================================
# Mobile dev helper for mobile-build worktree
# =============================================================================
# Builds the React frontend in "mobile" mode (API → http://3.64.236.66)
# and runs it on Android emulator or iOS Simulator.
#
# Usage:
#   scripts/mobile_dev.sh android         # build + install on emulator
#   scripts/mobile_dev.sh ios             # build + install on simulator
#   scripts/mobile_dev.sh build-only      # just build, no install
# =============================================================================
set -euo pipefail
